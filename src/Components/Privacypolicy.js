    ...
    <div className="privacy-policy-wrapper">
      ...
      <div className="privacy-content">
        ...
        <ul>
          ...
          <li>
            <strong>Application:</strong> Refers to PAT IoT, the software
            program provided by the Company.
          </li>
          <li>
            <strong>Company:</strong> Refers to PAT IoT Solutions Pvt. Ltd.
          </li>
          <li>
          ...
          <li>
            <strong>Service Provider:</strong> A third party employed by the
            Company to facilitate the Service.
          </li>
          <li>
            <strong>Usage Data:</strong> Data collected automatically by the
        ...
        <p>
          ...
          Service that you visit, the time and date of your visit, the duration
        ...
        <ul>
          <li>
            <strong>To provide and maintain our Service,including</strong> to
          ...
          <li>
            <strong>To provide you news</strong> news, special offers and
        ...
        <ul>
          <li>
            Comply with a legal obligation: We may process your data when
            required by law.
          </li>
          <li>
            Protect and defend the rights or property of the Company: This
            includes safeguarding our intellectual property and preventing
            unauthorized use.
          </li>
          <li>
            Prevent or investigate possible wrongdoing in connection with the
            Service: We may use your data to detect and prevent fraudulent
            activities or violations of our terms.
          </li>
          <li>
            Protect the personal safety of Users of the Service or the public:
            Ensuring the security and well-being of our users is a priority.
          </li>
          <li>
            Protect against legal liability: Your data may be used in legal
            proceedings to protect our company from claims or disputes.
          </li>
        </ul>
        ...
        <p>
          Our Service does not address anyone under the age of 3. We do not
          knowingly collect personally identifiable information from anyone
          under the age of 3. If You are a parent or guardian and You are aware
          that Your child has provided Us with Personal Data, please contact Us.
          If We become aware that We have collected Personal Data from anyone
          under the age of 3 without verification of parental consent, We take
        ...
        <ul>
          <li>
            ...
            <a href="https://patiot.in" className="text-blue-500">
              https://patiot.in
            </a>
          </li>
          <li>By phone: 9030983040</li>
        </ul>
      </div>
    </div>
  );
